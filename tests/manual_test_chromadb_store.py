...
async def test_chromadb_persistence():
    ...
    try:
        ...
        store1 = ChromaDBMemoryStore(collection_name="test_persist", persist_directory=temp_dir)

        # Store a document
        await store1.store("doc1", "persistent data", {"key": "value"})

        # Create new store instance pointing to same directory
        store2 = ChromaDBMemoryStore(collection_name="test_persist", persist_directory=temp_dir)
