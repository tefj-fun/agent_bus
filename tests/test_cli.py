...
class TestSkillsCLI:
    ...
    async def test_install_success(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("subprocess.run", side_effect=fake_git_clone):
                exit_code = await cli.install("https://github.com/test/new-skill", "new-skill")
    ...
    async def test_install_auto_name(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("subprocess.run", side_effect=fake_git_clone):
                ...
                exit_code = await cli.install("https://github.com/test/auto-skill.git")
    ...
    async def test_install_already_exists(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            exit_code = await cli.install("https://github.com/test/skill", "existing-skill")
    ...
    async def test_install_git_failure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("subprocess.run") as mock_run:
                ...
                exit_code = await cli.install("https://github.com/test/skill", "new-skill")
...
class TestCLIMain:
    ...
    def test_main_list(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("sys.argv", ["agent-bus-skills", "--skills-dir", tmpdir, "list"]):
                exit_code = main()
    ...
    def test_main_info_not_found(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch(
                "sys.argv", ["agent-bus-skills", "--skills-dir", tmpdir, "info", "nonexistent"]
            ):
                exit_code = main()
