...
def main():
    ...
    if not (base_url and email and token):
        print(
            "Missing Jira env vars. Need JIRA_BASE_URL/JIRA_EMAIL/JIRA_API_TOKEN", file=sys.stderr
        )
        return 2
    ...
    epic_key, epic_created = ensure_issue(
        ...
        description_adf=adf_doc(
            "Backlog for Phase 5: integration tests, durability, CI hardening."
        ),
