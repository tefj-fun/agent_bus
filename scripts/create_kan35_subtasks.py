...
def ensure_task(base_url: str, email: str, token: str, project_key: str, parent_key: str, summary: str, description: str):
...
- README updated''',
    ...
    for task in subtasks:
        key, is_new = ensure_task(base_url, email, token, project_key, parent_key, task['summary'], task['description'])
